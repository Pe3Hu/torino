...
func init_num() -> void:
	...
	num.size = {}
	num.size.segeltuch = {}
	num.size.segeltuch.a = 10
	num.size.segeltuch.zoom = 1
	num.size.loch = {}
	num.size.loch.r = 5
	num.size.loch.n = 710
	num.size.grenze = {}
	num.size.grenze.margin = num.size.segeltuch.a
...
func init_scene() -> void:
	scene.segeltuch = load("res://scene/1/segeltuch.tscn")
	scene.loch = load("res://scene/1/loch.tscn")
	scene.grenze = load("res://scene/1/grenze.tscn")
